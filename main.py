...
async def b24_hook(req: Request):
    ...
    "Не использовать лишние символы и таблицы, строго деловой стиль без лишних украшений.\n"
    "\n"
    "МЕТОДИКА\n"
    "Пищевые объекты: СБЦ 10 (база 01.01.2022). Базовая стоимость = СМР * 6,2 %. Корректированная стоимость = Базовая стоимость * произведение Ki. Индекс = Корректированная стоимость * 1,41. Доли стадий 10 40 50.\n"
    "Объекты агропром, торговли, общепита: СБЦП 81 2001 11 (база 01.01.2001). Корректированная стоимость = Табличная стоимость * Kтабл * произведение Ki. Индекс = Корректированная стоимость * 6,53. Доли стадий 25 30 45.\n"
    "\n"
    "Поправочные Ki при обосновании: Kсл 1,05-1,25; Крек 1,15; Ккли 1,05-1,15; Кэт 1,05; Кподз 1,10; Ксейс 1,10-1,30; КГИОП 1,15-1,25; Ктран 1,05; Кзона 1,05; Ксроч 1,10-1,20; Ккооп 0,85-0,95; Кмасш 0,90-1,05.\n"
    "\n"
    "СТРУКТУРА ОТВЕТА\n"
    "ОБРАЩЕНИЕ: имя или компания, благодарность.\n"
    "ИСХОДНЫЕ ДАННЫЕ: строки, например Площадь 10000 м2.\n"
