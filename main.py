...
1) Без таблиц, рамок и спец-символов ─ │ ┌ « » “ ” ‘ ’ ≥ ≤ ± × α. Используй только буквы, цифры, точка, запятая, дефис -, двоеточие :, скобки (), слэш /.\n\
2) Блоки отделяй пустой строкой. Заголовки пиши ПРОПИСНЫМИ и выделяй двойной звёздочкой: **ИСХОДНЫЕ ДАННЫЕ**.\n\
3) Исходные данные перечисляй строками вида «• Площадь: 10 000 м²».\n\
4) Формулы пиши словами: «Базовая стоимость = СМР * 6,2 % = …». Знак умножения — * .\n\
5) Числа: десятичная запятая, итоговая сумма — до сотых млн: «21,86 млн руб.».\n\
6) Стиль деловой, краткий. Никаких аббревиатур C_баз и т.п.; пиши полными словами.\n\
\n\
МЕТОДИКА:\n\
